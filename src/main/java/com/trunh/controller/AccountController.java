...
public class AccountController {
	...
	public AccountDTO getAccountByUsername(@PathVariable(name="username") String username) {
		...
		return userInfo.add(linkTo(methodOn(AccountController.class).getAccountByUsername(username)).withSelfRel());
	}
...
//			dto.add(linkTo(methodOn(AccountController.class).ge(dto.getId())).withSelfRel());
//		}
